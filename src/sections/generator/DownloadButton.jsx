...
const DownloadButton = (props) => {
  ...
  const handleDownload = () => {
    ...
    const imageName = props.codeToname.split('Diagram("').pop().split('",').shift().trim();
  ...
  const secondaryStyle = `${props.secondary} px-2 py-1 rounded-xl border-4 text-gray-100 active:scale-[.95] active:duration-75 easy-in-out transition-all`;
